...
*** TODO 29. Use Plain Attributes Instead of Get and Set Methods
    
*** TODO 30. Consider =@property= Instead of Refactoring Attributes
...
** Time
 ...
 #+CAPTION: Clock summary at [2019-07-15 Mon 14:26]
 | Headline                                       | Time   |      |      |
 |------------------------------------------------+--------+------+------|
 | *Total time*                                   | *9:30* |      |      |
 |------------------------------------------------+--------+------+------|

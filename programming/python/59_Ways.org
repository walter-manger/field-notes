...
*** DONE 30. Consider =@property= Instead of Refactoring Attributes
    ...
    That's a better, an non-destructive way to incremently improve a container class.
...
** Time
 ...
 #+CAPTION: Clock summary at [2019-07-17 Wed 16:01]
 | Headline                                       | Time    |      |      |
 |------------------------------------------------+---------+------+------|
 | *Total time*                                   | *10:09* |      |      |
 |------------------------------------------------+---------+------+------|
 ...
 | \_  Metaclasses and Attributes                 |         | 0:39 |      |
